...
final String nameColum = "nameColumn";
final String emailColumn = "emailColumn";
final String phoneColumn = "phoneColum";
...
class ContactHelper {
  ...
  Future<Database> initDb() async {
    ...
    return await openDatabase(path, version: 1,
      ...
      await db.execute(
          "CREATE TABLE $contacTable ( $idColumn INTEGER PRIMARY KEY, $nameColum TEXT, $emailColumn TEXT, $phoneColumn TEXT, $imgColumn TEXT)");
    });
  }
  ...
  Future<Contact> getContact(int id) async {
    ...
    List<Map> maps = await dbContact.query(contacTable,
        columns: [idColumn, nameColum, emailColumn, phoneColumn, imgColumn],
        where: "$idColumn = ?",
        whereArgs: [id]);
